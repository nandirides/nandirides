...
class DriverForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Rating and total_rides are normally system-generated,
        # therefore they are intentionally not included in this form.

        self.fields["driver_code"].help_text = (
...
class DriverBankAccountForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        # Prevent more than one primary account for a driver.
