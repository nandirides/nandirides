"""
Django settings for nandirides project.
...
SECRET_KEY = 'django-insecure-*)5oiu0(h6=!y^*5t(yhw1&g%$nrmn0%+uc2(v0ewhnddbpa^0'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'user.context_processors.site_data',
                "support.context_processors.notifications",
            ],
        },
    },
]
